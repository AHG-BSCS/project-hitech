...
export default function ViewClasses() {
  ...
  const filteredClasses = classes
    .filter(cls => cls.adviserId === currentUserId && cls.status !== 'archived')
    .filter(cls =>
            ...
            <tbody>
              {filteredClasses.map(cls => (
                <tr key={cls.id} className="hover:bg-blue-100 hover:text-black">
                  <td className="text-center px-4 py-2">{cls.sectionName}</td>
                  <td className="text-center px-4 py-2">{cls.gradeLevel}</td>
                  <td className="text-center px-4 py-2">{cls.adviser}</td>
                  <td className="text-center px-4 py-2">{cls.schoolYear || '-'}</td>
